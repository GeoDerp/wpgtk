...
![Security Scan Status](https://github.com/deviantfero/wpgtk/actions/workflows/security-scan.yml/badge.svg)
![CodeQL Analysis Status](https://github.com/deviantfero/wpgtk/actions/workflows/codeql-analysis.yml/badge.svg)
...
This project uses automated tools to ensure dependencies are secure:

- **Dependabot**: Automated dependency updates and security alerts
- **Security Scanning**: Continuous vulnerability scanning with pip-audit, safety, and bandit
